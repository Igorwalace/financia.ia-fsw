...
import ButtonUpgrade from "./button-upgrade";

const CardBasicSignature = () => {
    return (
        <>
            <div className='flex flex-col rounded-xl border-[1px] border-primary border-opacity-[8%]' >
                ...
                <div className='flex justify-center items-start flex-col gap-1 p-6 font-extralight' >
                    <div className="flex justify-center items-center gap-1" >
                        <CheckIcon size={17} className='text-primary' /><h1 className='text-sm' >Apenas 10 transações por dia 7/10</h1>
                    </div>
                    <div className="flex justify-center items-center gap-1" >
